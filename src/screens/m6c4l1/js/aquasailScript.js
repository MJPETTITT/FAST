...
var aquaValues = {
	...
	fgw_3:{data:['tokenfinGoods'],val:[6],areaTotal:9000},
	...
	cash_6:{data:['token5000','token1000','token100'],val:[2,3,1],areaTotal:8200},
	...
	cust_17:{data:['tokenInvoice','tokenfinGoods','token5000','token1000','token100'],val:[2200,0,0,2,2],areaTotal:2200},
};

var aquaSteps = {
	step_0:{
		text:'<h3>Complete Quarter 4</h3><p>Next you will complete all the transactions for Year 2, Quarter 4 in one sequence. Remember that you will again build 2 boats, and sell 3. Afterward, you will calculate Year 2, Quarter 4’s EBIT.</p>',
		questTxt:'First collect the amount invoiced from customers (1 boat sold last quarter): move 2200 from customers to <b>cash</b>.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
		...
		customcash:'yes',
		cashValues:[4,5,1],	
		areaData:[2200,0,0,0,0],
		areaDataTotal:0,
		areaData1:[1,5,4],
		areaDataTotal1:10400,		
		cashData:[4,5,1],
		cashTotal:10400,	
		changeSprite:'yes',
	...
	step_1:{
		...
		questTxt:'Pay suppliers: move 2000 from <b>cash</b> to suppliers to pay off the Quarter 3 <b>invoice</b>.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_9:{
		...
		questTxt:'Sales in Quarter 4 pick up thanks to the festive season and you sell 3 boats. Well done! Move 3 boats from the finished goods warehouse to customers.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_10:{
		text:'<h3>Well Done!</h3><p>You successfully moved the boats.</p>',
		questTxt:'Move the new <b>invoice</b> worth 6600 from <b>accounts receivable</b> to customers. This represents the <b>invoice</b> to the customers for the 3 boats they purchased.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
