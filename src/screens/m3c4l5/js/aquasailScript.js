...
var aquaValues = {
	...
	cash_6:{data:['token5000','token1000','token100'],val:[1,5,4],areaTotal:10400},
...
var aquaSteps = {	
	step_0:{
		text:'<h3>Pay taxes</h3><p>As you’ve already calculated, EBIT for Year 1 equals 2900. The interest paid on the bank loan, 2400, is a financial cost and has to be subtracted from the EBIT to arrive at the profit before tax figure. That makes Aquasail’s profit before tax 500. Aquasail has to pay taxes of 40% on profit.</p>',
		questTxt:'Move 200 from <b>cash</b> to <b>taxes</b>.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
		...
		cashTotal:10200,	
		changeSprite:'yes',
		changeSrc:'tax_sprite_a19',		
		complete:false
	},
	step_1:{
		text:'<h3>Well Done!</h3><p>You moved 200 (40% tax on profit of 500) from <b>cash</b> to <b>taxes</b>.</p>',
		questTxt:'',
		feedback:'yes',
		questPanel:'no',
		stayScreen:'no',
