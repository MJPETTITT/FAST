...
var aquaValues = {
	...
	cash_6:{data:['token5000','token1000','token100'],val:[1,5,2],areaTotal:10200},
	post_7:{data:[],val:[],areaTotal:0},
	accspay_8:{data:['tokenInvoice'],val:[4000],areaTotal:0},
	bankdt_9:{data:['tokenPost','token100'],val:[21000,0],areaTotal:0},
	equity_10:{data:['tokenPost','token100'],val:[14000,0],areaTotal:0},
...
var aquaSteps = {	
	step_0:{
		text:'<h3>Pay Bank Debt</h3><p>An important change in Year 2 is that you have successfully negotiated with your banker to pay back 9000 of the loan on January 1. This decreases the outstanding bank loan to 12000, of which 3000 is payable at the end of year 2 and the remainder is long term debt.</p>',
		questTxt:'Move 9000 from <b>cash</b> to the <b>bank</b>, to pay back part of the loan.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
		...
		updateArea:'yes',
		cursorImage:[1,4],
		cursorArrayClass:["token5000","token1000"],		
		...
		cashTotal:1200,	
		changeSprite:'yes',
		changeSrc:'bank_sprite_a20',		
		complete:false
	},
	step_1:{
		text:'<h3>Well Done!</h3><p>You successfully moved the <b>cash</b> to the <b>bank</b>.</p>',
		questTxt:'Aquasail now owes the bank only 12000 (=24000-3000-9000). Write this on a post-it and move it to <b>bank debt</b>.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
