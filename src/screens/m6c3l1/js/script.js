...
var feedback_text=["Update the <b>cash flow statement</b> using the figures above. Remember that outflows of cash are recorded with a minus figure. ","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>cash flow statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
...
var getAnswet=[];
var correctAnswer=['8800','-2000','-1000','-600'];
var cash_bal=['3000','11800','9800','8800'];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Now, update the Quarter 3 <b>cash flow statement</b> to show the 8800 payment of the 4 boats sold in Quarter 6, the payment of 2000 raw materials bought in Quarter 6, the 1000 labour cash outflow, and the 600 services cash outflow.');
