...
var feedback_text=["You will find the figure for taxes at the bottom of the Y2 <b>profit-and-loss statement</b> in the workbook.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the Year 2 cash book.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Update the Year 2 cash book with the tax payment of 1000.');
