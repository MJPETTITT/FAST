...
var aquaValues = {
	...
	fgw_3:{data:['tokenfinGoods'],val:[5],areaTotal:7500},
	...
	accspay_8:{data:['tokenInvoice'],val:[2000],areaTotal:0},
	...
	cust_17:{data:['tokenInvoice','tokenfinGoods','token5000','token1000','token100'],val:[8800,0,1,3,8],areaTotal:8800},
};

var aquaSteps = {
	step_0:{
		text:'<h3>Complete Quarter 3</h3><p>Next you will complete all the transactions for Year 2, Quarter 3 in one sequence. Afterward, you will estimate Year 2, Quarter 3’s EBIT.</p>',
		questTxt:'First collect the amount invoiced from customers (4 boats sold last quarter): move 8800 from customers to <b>cash</b>.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
		...
		customcash:'yes',
		cashValues:[8,6,1],	
		areaData:[8800,0,0,0,0],
		areaDataTotal:0,
		areaData1:[1,6,8],
		areaDataTotal1:11800,		
		cashData:[8,6,1],
		cashTotal:11800,	
		changeSprite:'yes',
	...
	step_1:{
		...
		questTxt:'Pay suppliers: move 2000 from <b>cash</b> to suppliers to pay off the Quarter 2 <b>invoice</b>.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_8:{
		...
		areaDataTotal:0,
		areaData1:[7],
		areaDataTotal1:10500,
		cashData:[2,3,1],
		cashTotal:8200,	
		changeSprite:'yes',
		assemblyLinesSprite:'def',	
		changeSrc:'finishedgood_sprite_a22_1',		
		complete:false	
	},
	step_9:{
		text:'<h3>Well Done!</h3><p>You successfully moved the boat.</p>',
		questTxt:'Autumn looms and you only sell 1 boat this quarter. Move 1 boat from the finished goods warehouse to customers.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
		...
		changeSrc1:'customers_sprite_a23_1',	
		complete:false
	},
	step_10:{
		text:'<h3>Well Done!</h3><p>You successfully moved the boat.</p>',
		questTxt:'Move the new <b>invoice</b> worth 2200 from <b>accounts receivable</b> to customers. This represents the <b>invoice</b> to the customers for the 1 boat they purchased.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
...
function showPopNext(){		
	...
	if(moveStep == 10) {
		finalBoatAnimation();
		$('#accsrecsprite_11').css('background-image','url('+simImgPath+'accsrec_sprite_a23.png)');
		aquaValues['accsrec_11']['data'] = ['tokenInvoice'];
		aquaValues['accsrec_11']['val'] = [2200];
	}
...
function finalBoatAnimation(){	
	...
	setAnimator.play({
		...
		onFrame: function(){
			...
			if((setAnimator.currentFrame() == 20) && boatStart < 1){
				boatStart++;
				finalBoatAnimation();
			}
		},
...
function appendArray(arr){	
	...
	if(trayimg == 'tokenfinGoods1500'){
		var boatName = (moveStep <= 8)?' boats':' boat';
		totalCash = aquaSteps['step_'+moveStep].cursorImage+boatName;		
	}
