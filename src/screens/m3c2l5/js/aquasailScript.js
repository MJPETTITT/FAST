...
var aquaSteps = {
	step_0:{
		text:'<h3>Sell boats!</h3><p>The boats are again ready to be sold. Unfortunately, Aquasail was not able to sell all its boats. Only 3 boats are sold, for  2200 per boat, and customers still pay <b>cash</b>. So, you now move the boats to the customers and receive <b>cash</b> in return. Remark that Aquasail’s <b>cash</b> on the bank has decreased during Quarter 2. This is due to the extra inventory of raw materials, and to falling sales.</p>',
		questTxt:'First move 6600 from customers to <b>cash</b>.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_1:{
		...
		questTxt:'Now move 3 sailboats from Finished Goods to customers.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
