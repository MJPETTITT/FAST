...
var aquaSteps = {
	step_0:{
		text:'<h3>Pay for Raw Materials</h3><p>As each sailboat requires raw materials worth 1000, you buy 4000 materials from suppliers. As Aquasail is a risky startup company, the suppliers require cash payment. You thereby exchange <b>cash</b> for materials with your suppliers.</p>',
		questTxt:'First move 4000 from <b>cash</b> to suppliers, reflecting the payment for raw materials needed to build the boats.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_2:{
		text:'<h3>Well Done!</h3><p>You&#39;ve succesfully moved 4 units of raw materials.</p>',
		questTxt:'',
		feedback:'yes',
		questPanel:'no',
		stayScreen:'no',
