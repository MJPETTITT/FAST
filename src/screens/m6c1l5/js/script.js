...
var feedback_text=["Update the cash balance according to the results of the cash inflow or outflow. Remember, your <b>cash</b> at start is 1200.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>cash flow statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
...
var getAnswet=[];
var correctAnswer=['4400','-4000','-1000','-600'];
var cash_bal=['1200','5600','1600','600'];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Update the Quarter 1 cash flow statement including the 4400 sales cash inflow, the 4000 raw materials outflow, the 1000 labour cash outflow, and the 600 services cash outflow.');
