...
var feedback_text=["Input the extra debt repayment of 9000. Remember that cash outflows are recorded as a minus.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the Year 2 <b>cash flow statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Complete the <b>cash flow statement</b> to show the repayment of the debt.');
