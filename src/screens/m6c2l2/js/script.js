...
var bal_feedback_text=["Remember to access the workbook overlay to find the figures you need.<br/> Hint: operating revenues (sales) are 8800.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>profit-and-loss statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var getAnswet=[];
var correctAnswer=['8800'];
var cash_bal=14400;
var BS_correctAnswer=['8800','2000','1000','600','400','3000'];
var showAnswer=['4000','7000','1800'];
var tot_equity=['','','','','',''];
var clickCount=1;			
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		else if(targetId==1)
		{
			$('.question').show();
			$('.move-box-holder').show();
			$('.contentStep').html('Now, update the Quarter 2 <b>profit-and-loss statement</b> to add the operating revenues and operating costs as well as depreciations in Quarter 1 of 400. Open the workbook and review the figures in the Year 2 budget.<br/><br/>Then, calculate the total cost of production by adding all the operating costs together.<br/><br/>Add in 3000 to the <b>inventory finished goods</b> line, and calculate the <b>cost of goods sold</b>.<br/><br/>Calculate Quarter 2 EBIT by subtracting the total <b>cost of goods sold</b> in Quarter 2 from sales in Quarter 2.<br/><br/>Remember, you may access the Year 2 budget from the workbook overlay for reference.');
