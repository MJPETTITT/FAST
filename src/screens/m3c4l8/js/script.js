...
var bal_feedback_text=["Using the figures in the <b>cash flow statement</b> and <b>profit-and-loss statement</b> in the workbook to fill in the <b>equity</b> and <b>liabilities</b> figures.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>profit-and-loss statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"];
var getAnswet=[];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		else if(targetId==1)
		{
			...
			$('.cash_statement').hide();
			$('.move-box-holder').show();
			$('.contentStep').html('Use the figures in the <b>cash flow statement</b> and <b>profit and loss statement</b> in the workbook (make sure you select the Year 1 statements), to update the <b>equity</b> and <b>liabilities</b> figures in the <b>balance sheet</b>.');
