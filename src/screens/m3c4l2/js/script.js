...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Update the Year 1, Quarter 4 <b>cash flow statement</b> to record the cash outflow of 4000 to pay of the previous <b>invoice</b> of 4000.');
