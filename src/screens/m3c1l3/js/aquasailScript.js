...
var aquaValues = {
	...
	rmw_4:{data:['tokenRawMat'],val:[4],areaTotal:4000},
	...
	cash_6:{data:['token5000','token1000','token100'],val:[3,2,2],areaTotal:17200},
...
var aquaSteps = {
	step_0:{
		text:'<h3>PAY WAGES</h3><p>You now need to assemble 4 sailboats in your assembly hall. Each assembly line will assemble 1 boat. Assembling 1 boat requires 1000 raw materials, plus employees whose wages amount to 500. So to assemble 4 boats you will need to pay 4 times 500, or 2000, to your employees. You are exchanging money for work.</p>',
		questTxt:'First move 4000 raw materials tokens from the raw materials warehouse to the assembly lines (1000 to each line). Remember that you can use the map icon to remind yourself where a location is in the simulation.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
		...
		cashTotal:17200,	
		changeSprite:'yes',
		changeSrc:'rawmaterials_sprite',
		assemblyLinesSprite:'a5_1',	
		complete:false	
	},
	step_1:{
		text:'<h3>Well Done!</h3><p>You successfully moved the tokens from raw materials.</p>',
