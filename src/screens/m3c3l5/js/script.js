...
var feedback_text=["Calculate the cash balance as a result of the 4400 sales cash inflow.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>cash flow statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var bal_feedback_text=["Calculate the cash balance as a result of the 2000 cash outflow.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the cash <b>cash flow statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var getAnswet=[];
var correctAnswer=['4400'];
var cash_bal=18200;
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Update the Year 1, Quarter 3 <b>cash flow statement</b> to show the cash inflow of boat sales of 4400.');
