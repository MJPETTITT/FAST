...
var aquaSteps = {
	step_0:{
		text:'<h3>BORROW CASH FROM BANK</h3><p>You have convinced your banker to lend Aquasail 24000 <b>cash</b>. Note that Aquasail will have to pay 10% interest per year on the outstanding amount, and 3000 of the principal amount has to be repaid on December 31 each year. The duration of the debt is hence 8 years.</p>',
		questTxt:'Move 24000 from the bank to <b>cash</b>.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_1:{
		text:'<h3>Well Done!</h3><p>You successfully moved the tokens from the <b>bank</b>.</p>',
