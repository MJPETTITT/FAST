...
var aquaValues = {
	...
	cash_6:{data:['token5000','token1000','token100'],val:[0,1,2],areaTotal:1200},
	post_7:{data:[],val:[],areaTotal:0},
	accspay_8:{data:['tokenInvoice'],val:[4000],areaTotal:0},
	bankdt_9:{data:['tokenPost','token100'],val:[1200,0],areaTotal:0},
	...
	cust_17:{data:['tokenInvoice','tokenfinGoods','token5000','token1000','token100'],val:[4400,0,0,4,4],areaTotal:4400},
};

var aquaSteps = {
	step_0:{
		text:'<h3>Complete Quarter 1</h3><p>You will complete all of Quarter 1 in this session, and record changes in cash after each move. Afterwards, you will update the Year 2, Quarter 1 <b>cash flow statement</b> and the Year 2, Quarter 1 <b>profit-and-loss statement</b> calculate this quarter’s EBIT.</p>',
		questTxt:'First collect the amount invoiced from customers (2 boats sold at the end of Year 1, Quarter 4)—move 4400 from customers to <b>cash</b>.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
		...
		updateArea:'no',
		cursorImage:[4,4],
		cursorArrayClass:["token1000","token100"],	
		customCursorSel:'cashsprite_6',		
		postBox:'',
		customcash:'yes',
		cashValues:[6,5,0],	
		areaData:[4400,0,0,0,0],
		areaDataTotal:0,
		areaData1:[0,5,6],
		areaDataTotal1:5600,		
		cashData:[6,5,0],
	...
	step_1:{
		...
		questTxt:'Pay suppliers: move 4000 from <b>cash</b> to suppliers to pay off the previous <b>invoice</b> from year 1.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_2:{
		text:'<h3>Well Done!</h3><p>You successfully paid off the <b>invoice</b>.</p>',
	...
	step_3:{
		text:'<h3>Well Done!</h3><p>You successfully moved the tokens.</p>',
		questTxt:'Move the new <b>invoice</b> with 2000 on it from suppliers to <b>accounts payable</b>. You will pay this <b>invoice</b> next quarter.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
		clickelem:'suplssprite_1',
	...
	step_6:{
		...
		questTxt:'Move 1 unit of wages from employees to each of the 2 operating assembly lines (2 units in total).',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_9:{
		...
		questTxt:'You sold 3 boats! Well done! Move 3 sailboat tokens from the finished goods warehouse to customers.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
		...
		cashTotal:0,	
		changeSprite:'yes',
		changeSrc:'finishedgood_sprite_a20',
		changeSrc1:'customers_sprite_a11_1',	
		complete:false
	},
	step_10:{
		text:'<h3>Well Done!</h3><p>You successfully moved the boats.</p>',
		questTxt:'Move the new <b>invoice</b> worth 6600 from <b>accounts receivable</b> to customers. This represents the <b>invoice</b> to the customers for the 3 boats they purchased. No cash changes hands.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
...
function showPopNext(){		
	...
	if(moveStep == 10) {
		finalBoatAnimation();
		$('#accsrecsprite_11').css('background-image','url('+simImgPath+'accsrec_sprite_a21.png)');
		aquaValues['accsrec_11']['data'] = ['tokenInvoice'];
		aquaValues['accsrec_11']['val'] = [6600];
	}
...
function finalBoatAnimation(){	
	...
	setAnimator.play({
		...
		onFrame: function(){
			...
			if((setAnimator.currentFrame() == 20) && boatStart < 3){
				boatStart++;
				finalBoatAnimation();
			}
		},
