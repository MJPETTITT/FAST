...
var aquaValues = {
	...
	cash_6:{data:['token5000','token1000','token100'],val:[3,3,2],areaTotal:18200},
	...
	cust_17:{data:['tokenfinGoods','token5000','token1000','token100'],val:[0,1,1,6],areaTotal:6600},
};

var aquaSteps = {
	step_0:{
		text:'<h3>Sell boats!</h3><p>The boats are again ready to be sold. Unfortunately, only 2 boats are sold, for 2200 per boat. Luckily, customers still pay <b>cash</b>. You move the boats to the customers and receive cash in return. </p>',
		questTxt:'First move 4400 from customers to <b>cash</b>.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_1:{
		...
		questTxt:'Now move 2 sailboats from finished goods to customers.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
		...
		cashTotal:22600,	
		changeSprite:'yes',
		changeSrc:'finishedgood_sprite_a15',
		changeSrc1:'customers_sprite_a15_1',	
		complete:false
	},	
	step_2:{
