...
var bal_feedback_text=["Calculate profit/loss before tax by combining interest costs (-1200) and EBIT (3700).","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly calculated profit/loss before tax</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var getAnswet=[];
var correctAnswer=['8800'];
var cash_bal=14400;
var BS_correctAnswer=['-1200','2500'];
var showAnswer=['','',''];
var tot_equity=['','','','','',''];
var clickCount=1;			
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		else if(targetId==1)
		{
			$('.question').show();
			$('.move-box-holder').show();
			$('.contentStep').html('Update the <b>profit-and-loss statement</b> to show the EBIT, interest costs and profit before taxes figures.<br/><br/>First you will need to calculate Aquasail’s profit or loss before taxes. If Aquasail reports a profit, it immediately has to pay 40% taxes on those profits.<br/><br/>EBIT for Year 2 equals 3700. The interest paid on the bank loan, 1200, is a financial cost and has to be subtracted from the EBIT to arrive at the profit before tax figure.');
