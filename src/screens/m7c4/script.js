...
var feedback_text=["Refer to the Year 2 <b>balance sheets</b> to find the figures you need.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly calculated the Year 2 debt ratio.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Input the correct liabilities and assets figures for the debt ratio for Year 2. The figures you need are in the Year 2 <b>balance sheets</b>. The debt ratio will then be calculated automatically.');
