...
var bal_feedback_text=["Remember, <b>operating revenues</b>: sales = 8800. <b>Operating costs</b>: raw materials used = 4000, labour costs = 2000, services = 800.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>profit-and-loss statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var getAnswet=[];
var correctAnswer=['8800'];
var cash_bal=14400;
var BS_correctAnswer=['8800','4000','2000','800'];
var showAnswer=['8800','4000','2000','800'];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Update the Quarter 1 <b>profit-and-loss statement</b> to show the revenues, and the cost of raw materials, wages and services from Year 1, Quarter 1. You should record the costs as positive numbers.');
		...
		else if(targetId==1)
		{
			$('.question').show();
			$('.move-box-holder').show();
			$('.contentStep').html('Update the Quarter 1 <b>profit-and-loss statement</b> to show the revenues, and the cost of raw materials, wages and services from Year 1, Quarter 1.<br/><br/><b>Operating revenues</b>: sales = 8800. <b>profit-and-loss statement</b>: raw materials used = 4000, labour costs = 2000, services = 800');
