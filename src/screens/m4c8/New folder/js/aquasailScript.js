...
var aquaSteps = {
	step_0:{
		text:'<h3>PAY WAGES</h3><p>Assembling 1 boat requires 1000 raw materials, plus employees whose wages amount to 500.</p>',
	...
	step_2:{
		text:'<h3>PAY WAGES</h3><p>You successfully moved the tokens from <b>cash</b>.</p>',
		questTxt:'Move a 500 token from employees to each of the 4 assembly lines – move 4 tokens in total. ',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
