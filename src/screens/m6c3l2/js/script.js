...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		else if(targetId==1)
		{
			$('.question').show();
			$('.move-box-holder').show();
			$('.contentStep').html('Now, update the Quarter 3 <b>profit-and-loss statement</b> to add the operating revenues related to the sales of 1 boat in Quarter 7 and operating costs as well as depreciations in Quarter 3 of 400.<br/><br/>Then, calculate the total cost of production by adding all the operating costs together.<br/><br/>Add in -1500 to the <b>inventory finished goods</b> line, and calculate the <b>cost of goods sold</b>.<br/><br/>Calculate Quarter 3 EBIT by subtracting the total <b>cost of goods sold</b> in Quarter 3 from sales in Quarter 3.');
