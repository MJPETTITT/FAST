...
var feedback_text=["Note that you can review the Aquasail's financial documents at any time by selecting the workbook icon in the upper left corner of the screen to access the FAST workbook.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You correctly calculated the new cash balance.   <br/><span><i>Select the forward arrow below to continue.</i></span>"]
...
var getAnswet=[];
var correctAnswer=['-1200','-3000'];
var cash_bal=['6800','5600'];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Now, update the new comments.');
