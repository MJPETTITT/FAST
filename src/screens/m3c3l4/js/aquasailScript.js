...
var aquaValues = {
	...
	cash_6:{data:['token5000','token1000','token100'],val:[4,4,2],areaTotal:14400},
...
var aquaSteps = {	
	step_0:{
		text:'<h3>PAY FOR SERVICES</h3><p>You now need to pay for all the services of the third quarter, to a total value of 800. Paying the services allows you to move your 4 sailboats from the assembly hall to the warehouse of finished goods.</p>',
