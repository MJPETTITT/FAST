...
var aquaValues = {
	...
	cash_6:{data:['token5000','token1000','token100'],val:[0,5,8],areaTotal:5800},
	...
	cust_17:{data:['tokenInvoice','tokenfinGoods','token5000','token1000','token100'],val:[6600,0,0,6,6],areaTotal:6600},
};

var aquaSteps = {	
	step_0:{
		text:'<h3>Pay the Bank</h3><p>At the end of the year, Aquasail has to settle its <b>bank</b> dues. First, it has to pay interest on its bank loan. Remember that Aquasail pays 10% on the outstanding amount, which you find on the simulation board. Then Aquasail has to pay 3000 of the principal amount, which will take the amount owed from 12000 to 9000.</p>',
		questTxt:'Move 1200 from cash to the Bank to pay the interest due, which equals 10% x 12000 (outstanding bank loan).',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
		...
		cashTotal:4600,	
		changeSprite:'yes',
		changeSrc:'bank_sprite_a25',		
		complete:false
	},
	step_1:{
		text:'<h3>Well Done!</h3><p>You successfully moved the tokens from <b>cash</b>.</p>',
		questTxt:'Now move 3000 from <b>cash</b> to the <b>bank</b> to pay off some of the principal amount you previously borrowed.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
		clickelem:'cashsprite_6',
		...
		cashTotal:1600,	
		changeSprite:'yes',
		changeSrc:'bank_sprite_a25_1',		
		complete:false	
	},
	step_2:{
		text:'<h3>Well Done!</h3><p>You successfully moved the tokens from <b>cash</b>.</p>',
		questTxt:'Aquasail now owes 12000-3000=9000 to the bank. Write this on a post-it and move it to <b>bank debt</b>.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
...
var goAquasailWorkBook = function(){
	...
	$('.contentStep').html('Calculate the new cash balance as a result of 1200 and 3000 cash outflow for interest and repayment to the bank.');
}
