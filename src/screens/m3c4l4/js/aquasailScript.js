...
var aquaValues = {
	...
	cash_6:{data:['token5000','token1000','token100'],val:[2,5,8],areaTotal:15800},
	...
	cust_17:{data:['tokenInvoice','tokenfinGoods','token5000','token1000','token100'],val:[4400,0,0,0,0],areaTotal:0},
};

var aquaSteps = {	
	step_0:{
		text:'<h3>Pay the Bank</h3><p>At the end of the year, Aquasail has to settle its bank dues. First, it has to pay interest on its bank loan, amounting to 10% on 24000, or 2400. Then Aquasail has to pay 3000 of the principal amount, which will take the amount owed from 24000 to 21000.</p>',
		questTxt:' First move 2400 from <b>cash</b> to the <b>bank</b> to pay the interest.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_1:{
		...
		cashTotal:10400,	
		changeSprite:'yes',
		changeSrc:'bank_sprite_a18_1',		
		complete:false	
	},
	step_2:{
		text:'<h3>Well Done!</h3><p>You successfully moved the tokens from <b>cash</b>.</p>',
		questTxt:'Finally, move the post-it with 21000 from the post-it pad to <b>bank debt</b>.This shows the new amount Aquasail owes to the <b>bank</b>.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
