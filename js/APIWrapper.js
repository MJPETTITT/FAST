...
function doLMSInitialize()
{
   ...
   if (api == null)
   {
	   console.log("doLMSInitialize: api == null");
      return "false";
   }
...
function LMSIsInitialized()
{
   ...
   else
   {
      ...
      var studID = api.LMSGetValue("cmi.core.student_id");
      var LessonLoc = api.LMSGetValue("cmi.core.lesson_location");
      var credit = api.LMSGetValue("cmi.core.credit");
      var LessonSts = api.LMSGetValue("cmi.core.lesson_status");
      var entry = api.LMSGetValue("cmi.core.entry");
      var total_time = api.LMSGetValue("cmi.core.total_time");
      var lesson_mode = api.LMSGetValue("cmi.core.lesson_mode");
      var exit = api.LMSGetValue("cmi.core.exit");
      var session_time = api.LMSGetValue("cmi.core.session_time");
      var suspend_data = api.LMSGetValue("cmi.core.suspend_data");
      var raw_score = api.LMSGetValue("cmi.core.score.raw");
      
      console.log("Student ID: " + studID);
      console.log("Student Name: " + value);
      console.log("Lesson Location: " + LessonLoc);
      console.log("credit: " + credit);
      console.log("Lesson Status: " + LessonSts);
      console.log("Entry: " + entry);
      console.log("Total Time: " + total_time);
      console.log("Lesson Mode: " + lesson_mode);
...
/*******************************************************************************
**
** Function Finished_time() / User defined function
** Inputs:  none
** Return:  It's returned session timing duration.
**
** Description:
** This function is calculated the session timeing.
**
*******************************************************************************/
function Finished_time() {
	console.log("Within onB4LMSFinish")
	var endTimeStamp = new Date();
    var totalMilliseconds = (endTimeStamp.getTime() - startTimeStamp.getTime());
    var scormTime = ConvertMilliSecondsToSCORMTime(totalMilliseconds, false);
	doLMSSetValue("cmi.core.session_time", scormTime);
	doLMSCommit();
	doLMSFinish();
}
