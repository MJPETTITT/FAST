...
var aquaSteps = {	
	step_0:{
		text:'<h3>PAY FOR SERVICES</h3><p>At the end of Quarter 2, you again pay all the services of the second quarter for a total value of 800. Paying the services allows you to move your 4 sailboats from the assembly hall to the warehouse of finished goods.</p>',
