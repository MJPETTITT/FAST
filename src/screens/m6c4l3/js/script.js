...
var bal_feedback_text=["Calculate the EBIT of Year 2 by adding together the EBITS of all 4 quarters.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the EBIT of Year 2.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var getAnswet=[];
var correctAnswer=['8800'];
var cash_bal=14400;
var BS_correctAnswer=['3700'];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		else if(targetId==1)
		{
			$('.question').show();
			$('.move-box-holder').show();
			$('.contentStep').html('Update the EBIT Year 2. Calculate the Total EBIT for Year 2 by adding together the EBITs of all 4 quarters.');
