...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Update the Year 1, Quarter 1 <b>cash flow statement</b> to record the cash outflow of 2000 in wages and the impact of that cash outflow on the cash balance.');
