...
var feedback_text=["Calculate the cash balance as a result of the 2000 cash outflow.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>cash flow statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Update the Year 1, Quarter 2 <b>cash flow statement</b> to record the cash outflow of 2000 in wages and the impact of that cash outflow on the cash balance.');
