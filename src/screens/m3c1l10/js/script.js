...
var bal_feedback_text=["Calculate the total cost of production by adding all <b>operating costs</b>.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>profit-and-loss statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var getAnswet=[];
var correctAnswer=['8800'];
var cash_bal=14400;
var BS_correctAnswer=['7200','400'];
var showAnswer=['7200','400'];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		else if(targetId==1)
		{
			$('.question').show();
			$('.move-box-holder').show();
			$('.contentStep').html('Update the Year 1, Quarter 1 <b>profit-and-loss statement</b> by adding depreciation as an operating cost of 400.<br/><br/>Then add up the <b>operating costs</b> to calculate the figure for the <b>cost of goods sold<b/>.');
