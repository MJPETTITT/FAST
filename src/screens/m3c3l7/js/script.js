...
var bal_feedback_text=["Refer to the P&L Year 1 sheet in the workbook if you need a reminder of the relevant figures.","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>profit-and-loss statement</b>.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var getAnswet=[];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		else if(targetId==1)
		{
			$('.question').show();
			$('.move-box-holder').show();
			$('.contentStep').html('Update the Year 1, Quarter 3 <b>profit-and-loss statement</b> with sales, raw materials, wages, services and depreciation. Sales were 4400, and the operating costs are the same as last quarter.<br/><br/>Calculate the Quarter 3 EBIT. Note that the cost of production, relating to the 4 assembled boats, did not change. It’s again 7200. Also take into account the change in inventory of finished goods.');
