...
var aquaValues = {
	...
	cash_6:{data:['token5000','token1000','token100'],val:[3,3,6],areaTotal:18600},
...
var aquaSteps = {
	step_0:{
		text:'<h3>Pay invoice and purchase raw materials</h3><p>Aquasail again assembles 4 sailboats, and therefore orders 4 units of raw materials from its supplier. However, before the supplier ships the order, its outstanding invoice has to be paid. So, you first pay the supplier and thereby remove the outstanding invoice. Then, you buy 4 new units of raw materials, which will be paid next quarter. So, you’ll get a new invoice that will go into <b>accounts payable</b>.</p>',
		questTxt:'First move 4000 from <b>cash</b> to suppliers to pay off the previous <b>invoice</b>.',
		feedback:'no',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_1:{
		...
		questTxt:'Now move 4 raw materials tokens from suppliers (each worth 1000) to the raw materials warehouse. This represents the raw materials you have just purchased from the suppliers.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
	...
	step_2:{
		...
		questTxt:'Move the new <b>invoice</b> with 4000 on it from suppliers to <b>accounts payable</b>.',
		feedback:'yes',
		questPanel:'yes',
		stayScreen:'no',
		clickelem:'suplssprite_1',
...
function hidePopNext(){
	if(moveStep == 2){ 
		$('#suplssprite_1').css('background-image','url('+simImgPath+'suppliers_sprite_a12.png)');		
