...
var bal_feedback_text=["To calculate the <b>cost of goods sold</b> you will need to add the <b>operating revenues</b> (6600) and <b>operating costs</b> (raw materials used, labour costs, services, depreciation)","Good try! Select the 'Show Me' button to reveal the correct answers and enter the numbers accordingly.","You have correctly updated the <b>profit-and-loss statement</b>. Note that the cost of production, relating to the 4 assembled boats, did not change. It is again 7200.<br/><span><i>Select the forward arrow below to continue.</i></span>"]
var getAnswet=[];
var correctAnswer=['8800'];
var cash_bal=14400;
var BS_correctAnswer=['6600','4000','2000','800','400'];
var showAnswer=['7200'];
var tot_equity=['','','','',''];
var clickCount=1;			
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Update the Quarter 1 <b>profit-and-loss statement</b> to show the revenues, and the cost of raw materials, wages and services from Year 1, Quarter 1.<br/><br/>Operating revenues: sales=8800 operating costs: raw materials used = 4000, labour costs = 2000, services = 800');
		...
		else if(targetId==1)
		{
			$('.question').show();
			$('.move-box-holder').show();
			$('.contentStep').html('Update the Year 1, Quarter 2 <b>profit-and-loss statement</b> by adding sales, raw materials, wages, services and depreciation. Note that all the operating cost items are the same as last quarter.');
