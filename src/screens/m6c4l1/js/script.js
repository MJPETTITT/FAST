...
var getAnswet=[];
var correctAnswer=['2200','-2000','-1000','-600'];
var cash_bal=['8200','10400','8400','7400'];
...
$(document).ready(function(){
	...
	$('.btn-text').on('click',function(){
		...
		if(targetId==0)
		{
			...
			$('.contentStep').html('Now, update the Quarter 4 <b>cash flow statement</b> to show the 2200 cash inflow, the 2000 raw materials cash outflow, the 1000 labour cash outflow, and the 600 services cash outflow.');
